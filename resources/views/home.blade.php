...
<div class="center_content">
    <div class="left_content">
      <div class="title"><span class="title_icon"><img src="{{asset('/assets/images/bullet1.gif')}}" alt="" /></span>Featured products</div>
      ...
      <div class="title"><span class="title_icon"><img src="{{asset('/assets/images/bullet2.gif')}}" alt="" /></span>New products</div>
      <div class="new_products">
        ...
        <div class="new_prod_box"> <a href="#">product name</a>
          <div class="new_prod_bg"> <span class="new_icon"><img src="{{asset('/assets/images/new_icon.gif')}}" alt="" /></span> <a href="#"><img src="{{asset('/assets/images/thumb3.gif')}}" alt="" class="thumb" border="0" /></a> </div>
        </div>
      </div>
      <div class="clear"></div>
    </div>
